...
#define STRING_CONFIG_H_AUTHOR "(Eric Psalmond)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BugBox 1.1.8 D"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // E3D v6 (PT100, 30W)
  #define  DEFAULT_Kp 27.48
  #define  DEFAULT_Ki 02.47
  #define  DEFAULT_Kd 76.31
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKi 36.74
  #define  DEFAULT_bedKd 374.94
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,180,400,417.5}  // default steps per unit for BigBox
/**
...
#define X_MIN_POS 0 // -38 for Dual, 0 for Pro
#define Y_MIN_POS 0
#define Z_MIN_POS 0
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 295 // BigBox | 295 for Dual, 235 for Pro
  ...
  #define UBL_SAVE_ACTIVE_ON_M500   // Save the currently active mesh in the current slot on
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 175    // X point for Z homing when homing all axes (G28).
